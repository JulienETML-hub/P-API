let livres = [
  {
    ...
    résumé:
      "Le drame de l'adultère d'Anna Karénine, qui entraîne des conséquences tragiques dans la haute société russe.",
    auteur: {
      nom: "Tolstoï",
      prénom: "Léon",
    },
  ...
  },
  {
    ...
    résumé:
      "Les aventures de Don Quichotte et de son fid_livreèle écuyer Sancho Panza, qui parcourent l'Espagne en quête d'id_livreéalisme.",
    auteur: {
      nom: "Cervantès",
      prénom: "Miguel de",
    },
  ...
  },
  {
    ...
    résumé:
      "Edmond Dantès cherche vengeance après avoir été trahi et emprisonné à tort.",
    auteur: {
      nom: "Dumas",
      prénom: "Alexandre",
    },
  ...
  },
  {
    ...
    résumé:
      "L'obsession du capitaine Achab pour traquer la baleine blanche, Moby Dick, à travers les océans.",
    auteur: {
      nom: "Melville",
      prénom: "Herman",
    },
  ...
  },
  {
    ...
    résumé:
      "Les aventures d'Ulysse, roi d'Ithaque, lors de son long voyage de retour après la guerre de Troie.",
    auteur: {
      nom: "Homère",
      prénom: "",
    },
  ...
  },
  {
    ...
    résumé:
      "Les aventures de d'Artagnan et de ses amis, les mousquetaires du roi, dans la France du XVIIe siècle.",
    auteur: {
      nom: "Dumas",
      prénom: "Alexandre",
    },
  ...
  },
  {
    ...
    résumé:
      "Le scientifique Victor Frankenstein crée une créature monstrueuse qui échappe à son contrôle.",
    auteur: {
      nom: "Shelley",
      prénom: "Mary",
    },
  ...
  },
  {
    ...
    résumé:
      "Les aventures de Tom Sawyer, un garçon espiègle, dans le Mississippi du XIXe siècle.",
    auteur: {
      nom: "Twain",
      prénom: "Mark",
    },
  ...
  },
  {
    ...
    résumé:
      "Les aventures et les épreuves des quatre sœurs March pendant la guerre de Sécession.",
    auteur: {
      nom: "Alcott",
      prénom: "Louisa May",
    },
  ...
  },
  {
    ...
    résumé:
      "Le compte terrifiant du vampire Dracula qui s'installe en Angleterre pour semer le chaos.",
    auteur: {
      nom: "Stoker",
      prénom: "Bram",
    },
  ...
  },
  {
    ...
    résumé:
      "Les aventures du professeur Aronnax à bord du sous-marin Nautilus, commandé par le mystérieux capitaine Nemo.",
    auteur: {
      nom: "Verne",
      prénom: "Jules",
    },
  ...
  },
  {
    ...
    résumé:
      "L'histoire d'amour entre Elizabeth Bennet et Mr. Darcy, confrontés à l'orgueil et aux préjugés sociaux de l'Angleterre du XIXe siècle.",
    auteur: {
      nom: "Austen",
      prénom: "Jane",
    },
  ...
  },
  {
    ...
    résumé:
      "Les tourments mentaux de Raskolnikov après avoir commis un meurtre, et sa quête de rédemption.",
    auteur: {
      nom: "Dostoïevski",
      prénom: "Fiodor",
    },
  ...
  },
  {
    ...
    résumé:
      "L'histoire de Jean Valjean, un ancien bagnard, et de ses rencontres avec d'autres personnages dans la France du XIXe siècle.",
    auteur: {
      nom: "Hugo",
      prénom: "Victor",
    },
  ...
  },
  {
    ...
    résumé:
      "Les aventures de Lemuel Gulliver dans des terres étranges, peuplées de créatures fantastiques.",
    auteur: {
      nom: "Swift",
      prénom: "Jonathan",
    },
  ...
  },
  {
    ...
    résumé:
      "L'histoire d'Hester Prynne, une femme condamnée pour adultère dans la Puritanisme de la Nouvelle-Angleterre.",
    auteur: {
      nom: "Hawthorne",
      prénom: "Nathaniel",
    },
  ...
  },
  {
    ...
    résumé:
      "Les intrigues et les manipulations des personnages aristocratiques dans la France pré-révolutionnaire.",
    auteur: {
      nom: "de Laclos",
